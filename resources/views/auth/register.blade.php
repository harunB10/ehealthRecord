...
@section('content')
    ...
    <div class="register-box">
        ...
        <div class="register-box-body">
            <p class="login-box-msg">Kreiranje novog korisničkog naloga</p>
            <form action="{{ url('/auth/register') }}" method="post">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group has-feedback">
                    <input type="text" class="form-control" placeholder="Ime i prezime" name="name" value="{{ old('name') }}"/>
                ...
                <div class="form-group has-feedback">
                    <input type="password" class="form-control" placeholder="Ponovite lozinku" name="password_confirmation"/>
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <div class="checkbox icheck">
                            <label>
                                <input type="checkbox"> Slažem se sa uslovima <a href="/ostalo/pravilnik.html">pravilnika</a>
                            </label>
                        </div>
                    </div><!-- /.col -->
                    <div class="col-xs-4">
            ...
            <a href="{{ url('/auth/login') }}" class="text-center">Već imam korisnički nalog</a>
        </div><!-- /.form-box -->
    </div><!-- /.register-box -->
